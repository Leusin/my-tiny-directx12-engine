...
RootSignature::RootSignature(Microsoft::WRL::ComPtr<ID3D12Device2> device, const D3D12_ROOT_SIGNATURE_DESC1& rootSignatureDesc,
...
void RootSignature::SetRootSignatureDesc(
    Microsoft::WRL::ComPtr<ID3D12Device2> device, const D3D12_ROOT_SIGNATURE_DESC1& rootSignatureDesc,
    D3D_ROOT_SIGNATURE_VERSION rootSignatureVersion)
{
    ...
    D3D12_STATIC_SAMPLER_DESC* pStaticSamplers = numStaticSamplers > 0 ? new D3D12_STATIC_SAMPLER_DESC[numStaticSamplers] :
                                                                         nullptr;
    ...
    ThrowIfFailed(D3DX12SerializeVersionedRootSignature(
        &versionRootSignatureDesc, rootSignatureVersion, &rootSignatureBlob, &errorBlob));
